package com.realizer.schoolgenie.managment.generalcommunication.asynctask;
...
public class TeacherGCommunicationAsyncTaskPost extends AsyncTask<Void, Void,StringBuilder>
{
    ...
    protected void onPostExecute(StringBuilder stringBuilder) {
        ...
        if(obj.getAnnouncementId() == (Integer.valueOf(obj.getAnnouncementTime()) - 1))
            obj1.setPriority("Last");
