...
public class ChatSectionIndexer extends AppCompatActivity implements OnTouchListener, View.OnClickListener{
  ...
  /*  private class SelectContactFilter implements Filterable {
    ...
    *//**
    ...
    {
        //Call API to Get all Student List std div

        AddedContactModel obj = new AddedContactModel();
        obj.setUserId("bb5eeb64-4508-11e7-a919-92ebcb67fe33");
        obj.setRollNo("1");
        obj.setUserName("Vivaan Salgare");
        obj.setProfileimage("");
        contactlist.add(obj);

        AddedContactModel obj1 = new AddedContactModel();
        obj1.setUserId("bb5eefc4-4508-11e7-a919-92ebcb67fe33");
        obj1.setRollNo("2");
        obj1.setUserName("Aarav Mahargude");
        obj1.setProfileimage("");
        contactlist.add(obj1);


        AddedContactModel obj2 = new AddedContactModel();
        obj2.setUserId("bb5ef21c-4508-11e7-a919-92ebcb67fe33");
        obj2.setRollNo("3");
        obj2.setUserName("Vihaan Patil");

        obj2.setProfileimage("");
